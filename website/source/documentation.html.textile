...
* "Parslet, An Introduction":https://docs.google.com/present/view?id=0AfXgUAUtzy
* "c7ZGZrcG1mNXNfMzIwZ3JjY2c3NW0 introduces parslet in a few poignant slides.
* "(Bo Jeanes and David Pick)

*Videos*

* "Writing DSL's with Parslet":http://www.confreaks.com/videos/2730
* "-wickedgoodruby-writing-dsl-s-with-parslet Talk given by Jason Garber at the
* "Wicked Good Ruby Conference 2013.
