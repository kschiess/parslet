...
# can be printed out as an ascii tree. ({Parslet::ParseFailureCause})
#
module Parslet
  ...
  # exceptions #parse_failure_cause member: It contains an instance of {Parslet::ParseFailureCause} that
  ...
  class ParseFailed < StandardError
    ...
    #
    # @return [Parslet::ParseFailiureCause]
...
require 'parslet/parse_failure_cause'
