...
The code we now have parses the input sucessfully, but doesn't do much else. 
...
* Arrays form a node storing a collection of subnodes anonymously
...
would whish for when constructing an abstract syntax tree. It corresponds to
this: 
